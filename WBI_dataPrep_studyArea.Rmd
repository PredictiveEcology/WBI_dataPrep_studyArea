...
df_params <- moduleParams("WBI_dataPrep_studyArea", "C:/Ian/Git")
...
If `sourceURL` is specified, `downloadData("WBI_dataPrep_studyArea", "C:/Ian/Git")` may be sufficient.

```{r moduleInputs, echo = FALSE}
df_inputs <- moduleInputs("WBI_dataPrep_studyArea", "C:/Ian/Git")
...
df_outputs <- moduleOutputs("WBI_dataPrep_studyArea", "C:/Ian/Git")
